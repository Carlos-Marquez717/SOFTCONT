...
ALLOWED_HOSTS = ['localhost','web-production-79ceb.up.railway.app']
CSRF_TRUSTED_ORIGINS=['http://*','https://web-production-79ceb.up.railway.app']
...
JAZZMIN_SETTINGS = {
    ...
    "topmenu_links": [
        ...
        {"name": "SOFTCON", "url": "home", "permissions": ["auth.view_user"]},
