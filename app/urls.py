...
from .views import (
    registrar_trabajador, lista_trabajador, registro_empresa, lista_empresa, eliminar, 
    registro_obrero, lista_obrero, eliminar_obrero, registro_pedido, lista_pedido, 
    eliminar_pedido, lista_pedido_trabajador, registro_material, eliminar_material, 
    lista_material, editar_material, editar_obrero, editar_empresa, editar_pedido, home, 
    registro_Herramienta, lista_Herramienta, editar_herramienta, eliminar_herramienta, 
    lista_prestamo, registrar_prestamo, editar_prestamo, lista_prestamos_obrero, 
    registro_Repuesto, eliminar_repuesto, lista_Repuesto, editar_Repuesto, 
    registro_RetiroRepuesto, lista_RetiroRepuesto, eliminar_RetiroRepuesto, 
    editar_RetiroRepuesto, lista_RetiroRepuesto_obrero, login, logout, generar_pdf_pedido, 
    ...
    pedidos_mes,pedidos_anio,upload_csv,lista_congelado,generate_pdf,pagina_con_botones,register
...
urlpatterns = [
    ...
    path('pedidos_dia/', pedidos_dia, name='pedidos_dia'),
    path('upload/', upload_csv, name='upload_csv'),
    path('lista/', lista_congelado, name='lista_congelado'),
    path('botones/', pagina_con_botones, name='pagina_con_botones'),
    path('generate_pdf/', generate_pdf, name='generate_pdf'),
    path('generate_pdf/personal/<str:personal>/', generate_pdf, name='generate_pdf_by_personal'),
