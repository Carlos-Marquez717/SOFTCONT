...
def generate_pdf(request, personal=None, empresa=None):
    ...
    logo_url = request.build_absolute_uri(static('https://softcont-production.up.railway.app/static/app/imgenes/minera.png'))
    logo_url1 = request.build_absolute_uri(static('http://softcont-production.up.railway.app/static/app/imgenes/logo.png'))
